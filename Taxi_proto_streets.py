...
while run:
    ...
    #drawing streets in green, [x, y] starting, [x, y] destination, 20 px thickness
    pygame.draw.line(game_window, GREEN, [70, 70], [600, 70], 20)
    pygame.draw.line(game_window, GREEN, [500, 61], [500, 300], 20)
    pygame.draw.line(game_window, GREEN, [510, 300], [100, 300], 20)
    pygame.draw.line(game_window, GREEN, [100, 291], [100, 600], 20)
    pygame.draw.line(game_window, GREEN, [100, 470], [600, 470], 20)
    ...
    #please add colission check/ check if player not on street       
    pygame.display.update()
